...
- 稳定版本：`0.7.5.9-qr-import-compatibility-agent-xray`
- 发布标签：`v0.7.5.5`
- 发布时间：`2026-06-28`
...
- `V0.7.5.9-qr-import-compatibility-agent-xray`：新增“高级：网络策略”，DNS、IPv6、QUIC、UDP、53 端口阻断和中国公共 DNS 阻断改为用户手动配置，默认不启用强阻断。
