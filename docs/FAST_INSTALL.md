# ZXY Panel V0.7.5.6 Fast Install Patch
...
4. `scripts/build-fast-release.sh`
   ...
   - 自动打包 `zxy-panel-v版本-fast-install.zip`
...
```bash
bash scripts/build-fast-release.sh 0.7.5.6
```

构建完成后会生成：

```text
dist-release/zxy-panel-v0.7.5.6-fast-install.zip
