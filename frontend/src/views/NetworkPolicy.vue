...
const modeTips: Record<string, string> = {
  compat: '默认推荐：保留 V0.7.5.9.1 稳定行为，公共 DNS + UseIPv4，不启用 53 阻断、不禁用 fallback、不阻断 QUIC。',
...
<template>
  <div class="page-head">
    <div>
      ...
      <p class="page-desc">V0.7.5.9.1：DNS、IPv6、QUIC、UDP、53 端口阻断全部由用户手动调配。升级不会自动启用强阻断，不会覆盖现网策略。</p>
    </div>
