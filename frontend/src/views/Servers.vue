...
const PACKAGE_NAME = 'zxy-panel-v0.7.6.0-base-stable.zip'
const PACKAGE_DIR = 'zxy-panel-v0.7.6.0-base-stable'
...
<template>
  <div class="page-head">
    <div>
      ...
      <p class="page-desc">V0.7.6.0 多服务器模式：本机服务器可作为主控/落地服务器，远程服务器复制一键命令后只安装 Agent 接入。</p>
    </div>
  </div>
  <div class="form">
